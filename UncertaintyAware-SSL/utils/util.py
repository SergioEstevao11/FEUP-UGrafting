...
Serj — 01/16/2024 7:43 PM
Holafly data
Serj — 01/17/2024 3:40 PM
...
3.1 Problem formalisation - formulação mais matemática
...
message.txt
3 KB
Serj — 03/09/2024 4:13 PM
O que fiz:

consultei implementações algortimos state of the art de supervised learning, Vision transformers pareceram-me a mais indicada visto que a maioria tem isto por base
consegui por um Swin transformer a correr
consegui uma source de datasets
Estava a ver implementações de diferentes


accuracy com o mapa de incerteza

loss landscape
Serj — 03/14/2024 3:26 PM
Self-Supervision + Uncertainty Quantification


Goal: Melhorar Self-Supervision com Uncertainty Quantification

Formas     - dando informação extra que UQ fornece
...
Serj — 03/14/2024 4:03 PM
2 cenário - Stochastic-attention ou Sub-Network

Transpor para várias tasks

brincar com a loss function
Serj — 03/25/2024 12:13 PM
Soares, sexo "em aberto", género radical, 22 anos, oriunda de terras onde a palavra "BUENOS" antecede sempre a palavra "DIAS". Deu entrada no SU, por estar enFARTAda de procurar um desporto em que não seja boa.

Corpo do Texto:
A Soares é a própria definição de "quem não arrisca, não petisca", com um currículo de desportos radicais que faria o mais destemido dos aventureiros corar. A sua paixão pela patinagem artística é tão intensa que sonha em transformar a pista de gelo numa pista de fogo, só para elevar o nível do desafio. Quando corre, parece que está sempre a fugir de um predador invisível, tal é a velocidade. No skate, realiza manobras com um nível de complexidade que faria os físicos questionarem as leis da gravidade. E quanto ao surf, é sabido que até os tubarões se afastam para admirar as suas habilidades. Não esquecendo a sua inclinação para histórias românticas com um toque vintage, especialmente aquelas que envolvem beijos com sabor a nostalgia — porque, afinal, a experiência vem com a idade.

Selecione as etiologias possíveis para o enFARTO:
A) Taquicardia funkeira – quando o coração bate ritmado com o funk mais próximo.
B) Úlcera alcoólica – condição marcada pela confiança desmedida no shot da casa do tasco.
C) O Sistema.
Serj — 03/26/2024 1:09 PM
Soares, sexo "em aberto", género radical, 22 anos, oriunda de terras onde a palavra "BUENOS" antecede sempre a palavra "DIAS". Deu entrada no SU, por estar enFARTAda de procurar um desporto em que não seja boa.

Corpo do Texto:
A Soares é a própria definição de "quem não arrisca, não petisca", e acreditem, ela acabou por petiscar bastante. Desde os dias de patinagem artística, a Soares sempre mostrou aptidão para cair, levantar-se outra vez, cair e levantar-se de novo, num ciclo que se alimenta a si mesmo mas que acaba por ter um fim quando damos por ela saciando o que procurávamos. É desta energia de manter este ciclo que a Soares fez um dos seus grandes feitos que é entrar em Medicina. Trocou os pisos de madeira, sapatos com rodas, fatiotas engraçadas, bebidas energéticas e campeonatos internacionais por chão de borracha, crocs e sapatinhos brancos, bata branca, café e cerveja, e festas académicas. Daqui, longe de casa e longe de amigos, arriscou e encontrou outra casa e mais amigos. Riu, chorou, desesperou, bebeu, bebeu, bebeu, desesperou mais um bocadinho, correu queimas e latadas, estudou um bocadinho lá pelo meio, dançou todas as músicas de funk que ouvia religiosamente, ganhou depressão crónica depois de ter visto o quão lindo é Nápoles, ganhou ansiedade crónica em todas as passadeiras visto que em Nápoles quase era atropelada por uma Vespa cinco vezes ao dia, e por fim, bebeu. 
Não esquecendo, por fim, a sua inclinação para histórias românticas com um toque vintage — porque, afinal, a experiência vem com a idade. 
Senhoras e Senhoras, a Soares, desportista, futura médica, professional risk taker, arriscadora de gema e dona do sorriso mais contagiante da academia.

Selecione as etiologias possíveis para o enFARTO:
A) Taquicardia funkeira – quando o coração bate ritmado com o funk mais próximo.
B) Úlcera alcoólica – condição marcada pela confiança desmedida no shot da casa.
C) O Sistema.
Serj — 03/28/2024 11:03 PM
...
I mean you already know I’m in… 😎🤝

Click the link in bio to build that dream trip you’ve been waiting for.. 🔗👉
...
falta orçamento, não depende do professor
Serj — 04/05/2024 5:52 AM
...
Sérgio Estêvão
Serj — 04/16/2024 6:24 PM
data augmentation - dirty side of self-supervision, very arbitrary

todo:

dar fix à loss function: para direct modelling e para mc-dropout

analizar qual seria a melhor opção

comparar com algoritmo normais (sem nada)

ver se existe melhor desempenho (melhor accuracy, será que falsos positivos desaparecem)

adicionar image net aos datasets

adicionar cityscape para tentar fazer segmentation
Serj — 04/19/2024 11:46 AM
pontos variancia média
calcular entropia
...
implementação da image-net com augmentações do DINOV2

descobertas:

vit são muito volateis no treino e exigem lr muito baixas (referencia do DINO e outros papers)
image augmentation: lado obscuro de self-supervison. pequenas alterações da augmentação podem fazer com que de facto o modelo aprenda ou não
accuracy do vit em geral: péssima
...
675.33 KB
Serj — 05/17/2024 1:04 PM
Attachment file type: acrobat
Pedido_contrato_de_bolsa_Sergio_Miguel_Rosa_Estevao.docx.pdf
112.98 KB
Serj — 05/21/2024 7:39 PM
My name is Sérgio, and I'm finishing my Master's in Software Engineering at the University of Porto and writing my thesis about Uncertainty Quantification in Self-Supervised Learning.
...
different loss function (OG focasse em manter um nivel de incerteza minimo, para garantir que os ensembles não colapsam)
GitHub
...
GitHub - wgcban/mix-bt: Official PyTorch Implementation of Guarding...
Serj — 05/25/2024 10:59 PM
PT50 0018 0003 1855 6811 0201 8
Serj — 05/26/2024 12:41 AM
...
que thresholding pode ser feito?? baseado na distribuição de incertezas medidas (se a incerteza que for medida numa prediction estiver nos top 10% (valor arbitrário), rejeitar)
Serj — 05/26/2024 2:18 AM
TODO:
mudar o embedding size de 128 para 1024

clarificar como o treino linear é feito (retirando a MLP layers)

mudar o linear training para incluir o MLP, pq este menino precisa de stochacity
Serj — 05/28/2024 1:25 PM
Responsible AI
Serj — 05/28/2024 1:46 PM
TODO:
...
Serj — 05/28/2024 6:42 PM
-> ver accuracy dos indices que não foram selecionados

Notas:

informação para o end-user, podemos dar as samples que não foram selecionadas, mas como uma flag!

informação para os devs, no aspeto de dizer quais as lacunas da rede, que tipo de classes a rede tem mais incerteza.
Serj — 05/31/2024 8:08 PM
https://image-net.org/data/ILSVRC/2012/ILSVRC2012_img_train.tar
Serj — 06/01/2024 11:14 PM
...
Serj — Today at 5:19 PM
Image
Serj — Today at 7:47 PM
